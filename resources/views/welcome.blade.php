...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Multiplier - Laravel</title>
...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        <div class="title m-b-md">
            <img src="https://multiplier.com.br/assets/multiplier.svg" alt="Multiplier Logo" class="brand">
        </div>

        <div class="links">
            <a href="https://github.com/alissonandrade2020/desafio-multiplier-back-end">Repositório</a>
